...
with open(output_filename, 'w') as outfile:
    ...
    for accession_number in accession_numbers:
        ...
        command = f"srun megahit -r ../flash/{accession_number}.extendedFrags.fastq -1 ../bowtie2/{accession_number}_paired_bt2_filtered.1.fastq -2 ../bowtie2/{accession_number}_paired_bt2_filtered.2.fastq -o {accession_number}_output\n"
