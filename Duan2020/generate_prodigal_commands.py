...
with open(output_filename, 'w') as outfile:
    ...
    for accession_number in accession_numbers:
        ...
        command = f"srun /temporario2/dmarques/Prodigal/Prodigal-GoogleImport/prodigal -i ../metaSpades/{accession_number}/contigs.fasta -o {accession_number}_coordinates -a {accession_number}_proteins.faa -d {accession_number}_genes.fasta\n"
