...
output_filename = 'flash_commands.txt'
...
with open(output_filename, 'w') as outfile:
    ...
    for accession_number in accession_numbers:
        ...
        command = f"srun flash -o {accession_number}  ../bowtie2/{accession_number}_paired_bt2_filtered.1  ../bowtie2/{accession_number}_paired_bt2_filtered.2 \n"
